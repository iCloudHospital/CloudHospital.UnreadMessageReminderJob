...
|   UnreadMessageReminderTimerSchedule    |    ✅    | -       | Timer schedule for unread message reminder job; Cron style schedule; e.g.) Trigger every 5 minutes. ➡️ 0 _/5 _ \* \* \*                                                 |
...
|               HelpUserId                |    ✅    | -       | Help account user id(Guid)                                                                                                                                              |
